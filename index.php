...
<html lang="en">
  ...
  <h4><img src="./img/trang1.jpeg" width="400px" alt=""></h4>
...
<h5 class="timlink"><i> 👉 <a href="./Ausbildungsanmeldung.php">Jetzt Ausbildungsplatz finden!</a> 
  ...
  <button
    class="inline-flex items-center px-5 py-3 bg-blue-600 text-white rounded-full shadow-md hover:bg-blue-700 transition duration-300">
    <!-- Icon: Briefumschlag -->
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m0 0v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8m18-2H3" />
    </svg>
    Nachricht senden
  </button>
